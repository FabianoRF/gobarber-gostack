...
var _ensureAutheticated = _interopRequireDefault(require("../../middlewares/ensureAutheticated"));
...
usersRouter.patch('/avatar', _ensureAutheticated.default, upload.single('avatar'), userAvatarController.update);
